...
var FieldsByPath = map[string]*FieldMeta{
	"notebooks":                        &SchemaFields[0],
	"explicit_projects":                &SchemaFields[1],
	"name":                             &SchemaFields[2],
	"workspaces":                       &SchemaFields[3],
	"ecosystem":                        &SchemaFields[4],
	...
	"tui":                              &SchemaFields[11],
	"flow.handoff_threshold":           &SchemaFields[12],
	"flow.handoff_max":                 &SchemaFields[13],
	"flow.interactive_provider":        &SchemaFields[14],
	"flow.oneshot_model":               &SchemaFields[15],
	"logging.level":                    &SchemaFields[16],
	"gemini.api_key_command":           &SchemaFields[17],
	"logging.system_level":             &SchemaFields[18],
	"flow.agent_env":                   &SchemaFields[19],
	"flow.providers":                   &SchemaFields[20],
	"logging.report_caller":            &SchemaFields[21],
	"logging.file":                     &SchemaFields[22],
	"logging.format":                   &SchemaFields[23],
	"logging.structured_pretty_fields": &SchemaFields[24],
	"logging.groups":                   &SchemaFields[25],
	"context":                          &SchemaFields[26],
	"flow.run_init_by_default":         &SchemaFields[27],
	"flow.max_consecutive_steps":       &SchemaFields[28],
	"logging.component_filtering":      &SchemaFields[29],
	"logging.show_current_project":     &SchemaFields[30],
	...
	"forge.url":                        &SchemaFields[38],
	"forge.token_command":              &SchemaFields[39],
	"forge.remote_name":                &SchemaFields[40],
	"forge.provider":                   &SchemaFields[41],
	"forge.poll":                       &SchemaFields[42],
	"flow.agent_target":                &SchemaFields[43],
}
