...
var SchemaFields = []FieldMeta{
	...
	},
	{
		...
		Priority:    1000,
		Namespace:   "forge",
		RefType:     "ForgeServicesConfig",
		Children: []FieldMeta{
			{
				Path:        []string{"services", "acme_dns_provider"},
				Type:        FieldString,
			...
			{
				Path:        []string{"services", "domain"},
				Type:        FieldString,
				Description: "DNS name of the forge services VM",
				Namespace:   "forge",
			},
			{
				Path:        []string{"services", "forgejo"},
				Type:        FieldObject,
				Description: "Forgejo service on the forge VM",
				Namespace:   "forge",
				RefType:     "ForgejoServiceConfig",
				Children: []FieldMeta{
					{
						Path:        []string{"services", "forgejo", "http_port"},
						Type:        FieldInt,
						Description: "Forgejo HTTP port",
						Namespace:   "forge",
					},
					{
						Path:        []string{"services", "forgejo", "sha256"},
						Type:        FieldString,
						Description: "SHA-256 of the Forgejo release binary",
						Namespace:   "forge",
					},
					{
						Path:        []string{"services", "forgejo", "site_name"},
						Type:        FieldString,
						Description: "Forgejo site name",
						Namespace:   "forge",
					},
					{
						Path:        []string{"services", "forgejo", "version"},
						Type:        FieldString,
			...
			{
				Path:        []string{"services", "syncd"},
				Type:        FieldObject,
				Description: "grove-syncd service on the forge VM",
				Namespace:   "forge",
				RefType:     "ForgeSyncdServiceConfig",
				Children: []FieldMeta{
					{
						Path:        []string{"services", "syncd", "enabled"},
						Type:        FieldBool,
						Description: "Colocate grove-syncd on the forge VM",
						Namespace:   "forge",
					},
					{
						Path:        []string{"services", "syncd", "port"},
						Type:        FieldInt,
	...
	},
	{
		...
		Priority:    1000,
		Namespace:   "forge",
		RefType:     "ForgeInfraConfig",
		Children: []FieldMeta{
			{
				Path:        []string{"infra", "cidr"},
				Type:        FieldString,
				Description: "Operator CIDR allowed to reach SSH and the service ports (never 0.0.0.0/0)",
				Namespace:   "forge",
			},
			{
				Path:        []string{"infra", "disk_size_gb"},
				Type:        FieldInt,
				Description: "Boot disk size in GB",
				Namespace:   "forge",
			},
			{
				Path:        []string{"infra", "enable_iap_ssh"},
				Type:        FieldBool,
			...
			{
				Path:        []string{"infra", "image_family"},
				Type:        FieldString,
				Description: "OS image family",
				Namespace:   "forge",
			},
			{
				Path:        []string{"infra", "image_project"},
				Type:        FieldString,
				Description: "Project owning the OS image",
				Namespace:   "forge",
			},
			{
				Path:        []string{"infra", "machine_type"},
				Type:        FieldString,
				Description: "GCE machine type",
				Namespace:   "forge",
			},
			{
				Path:        []string{"infra", "project"},
				Type:        FieldString,
				Description: "GCP project id for the forge VM",
				Namespace:   "forge",
			},
			{
				Path:        []string{"infra", "service_account_email"},
				Type:        FieldString,
			...
			{
				Path:        []string{"infra", "vm_name"},
				Type:        FieldString,
				Description: "Forge VM instance name",
				Namespace:   "forge",
			},
			{
				Path:        []string{"infra", "zone"},
				Type:        FieldString,
...
var FieldsByPath = map[string]*FieldMeta{
	...
	"gemini.api_key_command":           &SchemaFields[16],
	"logging.level":                    &SchemaFields[17],
	"flow.oneshot_model":               &SchemaFields[18],
	"logging.system_level":             &SchemaFields[19],
	"flow.agent_env":                   &SchemaFields[20],
	"logging.report_caller":            &SchemaFields[21],
	"flow.providers":                   &SchemaFields[22],
	...
	"forge.poll":                       &SchemaFields[39],
	"forge.remote_name":                &SchemaFields[40],
	"forge.provider":                   &SchemaFields[41],
	"forge.services":                   &SchemaFields[42],
	"forge.infra":                      &SchemaFields[43],
	"forge.backup":                     &SchemaFields[44],
	"flow.agent_target":                &SchemaFields[45],
	"forge.wireguard":                  &SchemaFields[46],
	"forge.url":                        &SchemaFields[47],
	"forge.token_command":              &SchemaFields[48],
	"search_paths":                     &SchemaFields[49],
}
