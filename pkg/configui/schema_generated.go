...
var FieldsByPath = map[string]*FieldMeta{
	...
	"logging.groups":                   &SchemaFields[26],
	"context":                          &SchemaFields[27],
	"flow.run_init_by_default":         &SchemaFields[28],
	"flow.max_consecutive_steps":       &SchemaFields[29],
	"logging.component_filtering":      &SchemaFields[30],
	"logging.show_current_project":     &SchemaFields[31],
	"flow.recipes":                     &SchemaFields[32],
	"onboarding":                       &SchemaFields[33],
	"logging.log_startup":              &SchemaFields[34],
	...
	"flow.agent_target":                &SchemaFields[40],
}
