		...
		Sections: []SectionEntry{
			...
			},
			{
				...
				Bindings: []BindingEntry{
					...
					{Name: "tab 1", Keys: []string{"1"}, Description: "tab 1", Enabled: true, ConfigKey: "tab1"},
					{Name: "tab 2", Keys: []string{"2"}, Description: "tab 2", Enabled: true, ConfigKey: "tab2"},
					{Name: "tab 3", Keys: []string{"3"}, Description: "tab 3", Enabled: true, ConfigKey: "tab3"},
					{Name: "tab 4", Keys: []string{"4"}, Description: "tab 4", Enabled: true, ConfigKey: "tab4"},
					{Name: "tab 5", Keys: []string{"5"}, Description: "tab 5", Enabled: true, ConfigKey: "tab5"},
					{Name: "tab 6", Keys: []string{"6"}, Description: "tab 6", Enabled: true, ConfigKey: "tab6"},
					{Name: "tab 7", Keys: []string{"7"}, Description: "tab 7", Enabled: true, ConfigKey: "tab7"},
					{Name: "tab 8", Keys: []string{"8"}, Description: "tab 8", Enabled: true, ConfigKey: "tab8"},
					{Name: "tab 9", Keys: []string{"9"}, Description: "tab 9", Enabled: true, ConfigKey: "tab9"},
		...
		Sections: []SectionEntry{
			...
			},
			{
				...
				Bindings: []BindingEntry{
					...
					{Name: "edit dependencies", Keys: []string{"ctrl+d"}, Description: "edit dependencies", Enabled: true, ConfigKey: "edit_deps"},
					{Name: "demote to note", Keys: []string{"D"}, Description: "demote to note", Enabled: true, ConfigKey: "demote_to_note"},
		...
		Sections: []SectionEntry{
			{
				...
				Bindings: []BindingEntry{
					...
					{Name: "manage groups", Keys: []string{"E"}, Description: "manage groups", Enabled: true, ConfigKey: "groups"},
					{Name: "new group", Keys: []string{"N"}, Description: "new group", Enabled: true, ConfigKey: "new_group"},
					{Name: "delete group", Keys: []string{"D"}, Description: "delete group", Enabled: true, ConfigKey: "delete_group"},
					...
					{Name: "move to group", Keys: []string{"M"}, Description: "move to group", Enabled: true, ConfigKey: "move_to_group"},
				},
			},
			{
				Name: "Navigation",
		...
		Sections: []SectionEntry{
			...
			},
			{
				...
				Bindings: []BindingEntry{
					{Name: "next group", Keys: []string{"tab"}, Description: "next group", Enabled: true, ConfigKey: "next_group"},
					{Name: "prev group", Keys: []string{"shift+tab"}, Description: "prev group", Enabled: true, ConfigKey: "prev_group"},
					{Name: "filter to group", Keys: []string{"F"}, Description: "filter to group", Enabled: true, ConfigKey: "filter_group"},
